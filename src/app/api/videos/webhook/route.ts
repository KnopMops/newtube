...
export const POST = async (req: Request) => {
	...
	switch (payload.type as WebhookEvent['type']) {
		...
		case 'video.asset.ready': {
			...
			const tmpThumbnailUrl = `https://image.mux.com/${playbackId}/thumbnail.jpg`

			const tmpPreviewUrl = `https://image.mux.com/${playbackId}/animated.gif`

			const utapi = new UTApi()
			const [uploadedThumbnail, uploadedPreview] =
				await utapi.uploadFilesFromUrl([tmpThumbnailUrl, tmpPreviewUrl])
